...
export async function load({ fetch }) {
    ...
    let addr = PUBLIC_MTV_BACKEND + 'startrek/lowerdecks/01';
    let addr2 = PUBLIC_MTV_BACKEND + 'startrek/lowerdecks/02';
    let addr3 = PUBLIC_MTV_BACKEND + 'startrek/lowerdecks/03';

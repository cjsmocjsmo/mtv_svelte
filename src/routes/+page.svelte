...
<main>
	...
	<div>
		<div class="movicon">
			<a href="/tvshows"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512">
				<path
		...
		<div class="movlist">
			...
			<a data-sveltekit-preload-data="tap" href="buzz"><p class="mov">Buzz</p></a>
			<a data-sveltekit-preload-data="tap" href="cartoons"><p class="mov">Cartoons</p></a>
			<a data-sveltekit-preload-data="tap" href="charliebrown"><p class="mov">Charlie Brown</p></a>
			...
			<a data-sveltekit-preload-data="tap" href="jurassicpark"><p class="mov">Jurrasic Park</p></a>
			...
			<a data-sveltekit-preload-data="tap" href="minions"><p class="mov">Minions</p></a>
			...
			<a data-sveltekit-preload-data="tap" href="oldies"><p class="mov">Oldies</p></a>
			...
			<a data-sveltekit-preload-data="tap" href="tinkerbell"><p class="mov">Tinker Bell</p></a>
